module github.com/renanbastos93/weaverdemo

go 1.21

toolchain go1.22.3

replace github.com/ServiceWeaver/weaver => /Users/unknow/git/folks/weaver

require github.com/ServiceWeaver/weaver v0.24.2
